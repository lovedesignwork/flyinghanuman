...
export function SafetyCertifications() {
  return (
    <section className="relative py-24 bg-[#f2e421]">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <motion.div
              ...
              viewport={{ once: true }}
              className="inline-flex items-center gap-2 px-4 py-2 bg-black text-[#f2e421] rounded-full text-sm font-medium mb-6"
            >
            ...
            <motion.h2
              ...
              className="text-4xl md:text-5xl font-[family-name:var(--font-trade-winds)] text-black mb-6"
            >
              World-Class
              <br />
              Safety Standards
            ...
            >
              At Flying Hanuman, we believe adventure should never compromise safety. 
                ...
                >
                  ...
                  <div className="flex-shrink-0">
                    <div className="w-14 h-14 rounded-2xl bg-black flex items-center justify-center group-hover:bg-[#1a1a1a] transition-colors">
                      <span className="text-[#f2e421] font-[family-name:var(--font-trade-winds)] text-lg">
                        {item.step}
                      </span>
                    </div>
                  </div>
          ...
          >
            ...
            >
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 bg-[#f2e421] rounded-xl flex items-center justify-center">
                  <CheckCircle className="w-8 h-8 text-black" />
                </div>
                <div>
                  <div className="text-2xl font-bold text-[#f2e421]">100%</div>
            ...
            >
              <div className="flex items-center gap-3">
                <Award className="w-8 h-8 text-[#f2e421]" />
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 bg-[#f2e421] rounded-2xl flex items-center justify-center">
                <Shield className="w-8 h-8 text-black" />
              </div>
              <div>
                <h3 className="text-[#f2e421] font-semibold text-xl">Full Insurance Coverage</h3>
                <p className="text-white/60">Comprehensive insurance included with every booking</p>
              </div>
            </div>
            <div className="flex items-center gap-6 text-white/60">
              <div className="text-center">
                <div className="text-2xl font-bold text-[#f2e421]">฿5M</div>
                <div className="text-xs">Coverage</div>
              </div>
              <div className="w-px h-12 bg-white/20" />
              <div className="text-center">
                <div className="text-2xl font-bold text-[#f2e421]">24/7</div>
