...
const baseUrl = process.env.NEXT_PUBLIC_APP_URL || 'https://flyinghanuman.com';
...
export const BookingConfirmationEmail = ({
  ...
  const previewText = `Your Flying Hanuman adventure is confirmed! Booking #${bookingRef}`;
        ...
        <Container style={container}>
          ...
          <Section style={successBanner}>
            ...
            <Text style={successSubtitle}>
              Thank you for choosing Flying Hanuman, {customerName}!
            </Text>
          </Section>
          ...
          <Section style={contactSection}>
            ...
            <Text style={contactText}>
              📧 Email: <Link href="mailto:info@flyinghanuman.com" style={contactLink}>info@flyinghanuman.com</Link>
            </Text>
            <Text style={contactText}>
          ...
          <Section style={footer}>
            ...
            <Text style={footerText}>
              Phuket&apos;s Premier Zipline Adventure
            </Text>
            <Row style={socialRow}>
              <Column style={socialCol}>
                <Link href="https://www.facebook.com/flyinghanuman" style={socialLink}>
                  Facebook
                </Link>
              </Column>
              <Column style={socialCol}>
                <Link href="https://www.instagram.com/flyinghanuman" style={socialLink}>
                  Instagram
                </Link>
              </Column>
              <Column style={socialCol}>
            ...
            <Text style={footerCopyright}>
              © 2026 Flying Hanuman. All rights reserved.
            </Text>
          </Section>
        </Container>
      </Body>
