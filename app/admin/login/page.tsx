      ...
      >
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-[#1a1a1a] px-8 py-6 text-center">
            <div className="w-16 h-16 bg-[#f2e421] rounded-2xl flex items-center justify-center mx-auto mb-4">
              <span className="text-black font-bold text-2xl">FH</span>
            </div>
            <h1 className="text-2xl font-bold text-white">Admin Login</h1>
            <p className="text-white/70 text-sm mt-1">Flying Hanuman Management</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin@flyinghanuman.com"
                  className="w-full h-12 pl-11 pr-4 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 focus:outline-none focus:border-[#f2e421] focus:ring-1 focus:ring-[#f2e421]"
                  required
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-12 pl-11 pr-12 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 focus:outline-none focus:border-[#f2e421] focus:ring-1 focus:ring-[#f2e421]"
                  required
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-12 bg-[#f2e421] hover:bg-[#d4c91e] text-black font-bold rounded-xl flex items-center justify-center gap-2 transition-colors disabled:opacity-50"
            >
              {loading ? (
                <>
