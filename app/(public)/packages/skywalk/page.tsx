...
import { Bus, Clock, ArrowRight, Check, Eye } from 'lucide-react';
import { Container, Section } from '@/components/ui';
import { getPackagesByCategory } from '@/lib/data/packages';
import { formatPrice } from '@/lib/utils';

const statLabels: Record<string, string> = {
  skywalkMetres: 'm Total',
  height: 'm Height',
  platforms: 'Platforms',
  views: 'Views',
};

export default function SkywalkPackagesPage() {
  const packages = getPackagesByCategory('skywalk');

  return (
    <main className="min-h-screen">
      {/* Hero Section */}
      <section className="relative py-24 bg-[#1a1a1a] overflow-hidden">
        <div className="absolute inset-0 bg-[url('/images/Hero%20Image/Skywalk.jpg')] bg-cover bg-center opacity-20" />
        ...
        <Container className="relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-[family-name:var(--font-trade-winds)] text-white mb-6">
              Sky <span className="text-[#f2e421]">Walk</span>
            </h1>
            <p className="text-lg text-white/70">
              Walk among the clouds on our elevated walkways. Enjoy stunning panoramic views 
              of Phuket&apos;s pristine jungle landscape from above the canopy.
            </p>
          </motion.div>
        </Container>
      </section>
                  ...
                  <div className="flex flex-col lg:flex-row">
                    ...
                    <div className="relative h-72 lg:h-auto lg:w-[40%] overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4 flex gap-2">
                        ...
                        <span className="px-3 py-1 bg-sky-500 text-white text-sm font-medium rounded-full flex items-center gap-1">
