...
import { Bus, Clock, ArrowRight, Check, Rocket } from 'lucide-react';
...
export default function SlingshotPackagesPage() {
  const packages = getPackagesByCategory('slingshot');

  return (
    <main className="min-h-screen">
      {/* Hero Section */}
      <section className="relative py-24 bg-[#1a1a1a] overflow-hidden">
        <div className="absolute inset-0 bg-[url('/images/Hero%20Image/Slingshot2.jpg')] bg-cover bg-center opacity-20" />
        ...
        <Container className="relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-[family-name:var(--font-trade-winds)] text-white mb-6">
              <span className="text-[#f2e421]">Slingshot</span>
            </h1>
            <p className="text-lg text-white/70">
              Get catapulted into the jungle canopy! The ultimate adrenaline rush for thrill-seekers. 
              Experience the extreme launch and feel the G-force.
            </p>
          </motion.div>
        </Container>
      </section>
