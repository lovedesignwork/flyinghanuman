...
import { Bus, Clock, ArrowRight, Check } from 'lucide-react';
        ...
        <Container className="relative z-10">
          ...
          >
            <span className="inline-block px-4 py-2 bg-[#f2e421]/10 text-[#f2e421] rounded-full text-sm font-medium mb-6">
              Pure Zipline Experience
            </span>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-[family-name:var(--font-trade-winds)] text-white mb-6">
              Zipline <span className="text-[#f2e421]">Adventures</span>
            </h1>
            <p className="text-lg text-white/70">
              Experience the thrill of flying through the ancient rainforest canopy. 
              Choose from our range of zipline packages for an unforgettable adventure.
            </p>
          </motion.div>
        </Container>
      </section>
                    ...
                    <div className="relative p-8 lg:p-10 lg:w-[60%]">
                      ...
                      {pkg.stats && (
                        <div className="grid grid-cols-3 sm:grid-cols-4 gap-4 mb-6">
                          {Object.entries(pkg.stats).slice(0, 4).map(([key, value]) => (
