          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 bg-[#0f0f0f] rounded-xl border border-white/10">
                <div className="w-12 h-12 bg-[#f2e421]/10 rounded-xl flex items-center justify-center mb-4 mx-auto">
                  <Star className="w-6 h-6 text-[#f2e421]" />
                </div>
              ...
              <div className="p-6 bg-[#0f0f0f] rounded-xl border border-white/10">
                <div className="w-12 h-12 bg-[#f2e421]/10 rounded-xl flex items-center justify-center mb-4 mx-auto">
                  <Bus className="w-6 h-6 text-[#f2e421]" />
                </div>
              ...
              <div className="p-6 bg-[#0f0f0f] rounded-xl border border-white/10">
                <div className="w-12 h-12 bg-[#f2e421]/10 rounded-xl flex items-center justify-center mb-4 mx-auto">
                  <Users className="w-6 h-6 text-[#f2e421]" />
                </div>
