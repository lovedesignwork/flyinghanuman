    ...
    <main className="pt-20">
      <Section className="bg-gradient-to-b from-[#1a1a1a] to-[#2d2d2d] py-16">
        <Container>
          ...
          >
            <Shield className="w-16 h-16 text-[#f2e421] mx-auto mb-4" />
            <h1 className="text-4xl font-bold text-white mb-4 font-[family-name:var(--font-trade-winds)]">Safety Information</h1>
        ...
        <Container>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-10">
              <div className="bg-[#f2e421]/10 border border-[#f2e421]/30 rounded-xl p-5 text-center">
                <Scale className="w-10 h-10 text-[#1a1a1a] mx-auto mb-3" />
                <h3 className="font-bold text-slate-800 mb-1">Weight Limit</h3>
                <p className="text-2xl font-bold text-[#1a1a1a]">15 - 120 kg</p>
              ...
              <div className="bg-[#f2e421]/10 border border-[#f2e421]/30 rounded-xl p-5 text-center">
                ...
                <p className="text-2xl font-bold text-[#1a1a1a]">4 Years</p>
              ...
              <div className="bg-[#f2e421]/10 border border-[#f2e421]/30 rounded-xl p-5 text-center">
                ...
                <p className="text-2xl font-bold text-[#1a1a1a]">30 Minutes</p>
            ...
            <div className="prose prose-slate max-w-none">
              ...
              <div className="bg-slate-100 rounded-xl p-4 not-prose">
                <p className="text-sm text-slate-600">
                  <strong>Note:</strong> Flying Hanuman is not responsible for lost, damaged, 
              ...
              <p>
                At Flying Hanuman, safety is our top priority. Our commitment includes:
              </p>
              <ul>
              ...
              <ul>
                <li>Email: safety@flyinghanuman.com</li>
