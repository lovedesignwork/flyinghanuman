    ...
    <main className="pt-20">
      <Section className="bg-gradient-to-b from-[#1a1a1a] to-[#2d2d2d] py-16">
        <Container>
          ...
          >
            <h1 className="text-4xl font-bold text-white mb-4 font-[family-name:var(--font-trade-winds)]">Terms & Conditions</h1>
      ...
      <Section className="bg-white py-12">
        <Container>
          ...
          >
            ...
            <p>
              Welcome to Flying Hanuman, operated by <strong>SKY TREK ADVENTURES Co., Ltd.</strong> 
            ...
            <h3>3.7 Cancellation by Flying Hanuman</h3>
            <p>
            ...
            <p>
              Flying Hanuman may photograph or film activities for promotional, marketing, 
            ...
            <p>
              ...
              the property of SKY TREK ADVENTURES Co., Ltd. and is protected by copyright 
              and trademark laws. Unauthorized use is prohibited.
            </p>

            <h2>11. Limitation of Liability</h2>
            <p>
              To the maximum extent permitted by law, SKY TREK ADVENTURES Co., Ltd. and 
            ...
            <h3>SKY TREK ADVENTURES Co., Ltd. (Flying Hanuman)</h3>
            <ul>
              <li>Email: info@flyinghanuman.com</li>
