  ...
  return (
    <main className="min-h-screen bg-[#1a1a1a]">
      <Section 
        ...
        style={{ background: 'linear-gradient(135deg, #1a1a1a 0%, #2d2d2d 30%, #252525 60%, #1a1a1a 100%)' }}
      >
                  ...
                  <AnimatePresence>
                    {isDropdownOpen && (
                      <motion.div
                        ...
                        exit={{ opacity: 0, y: -10 }}
                        className="absolute z-50 w-full mt-2 rounded-xl border-2 border-white/20 bg-[#2d2d2d] shadow-2xl overflow-hidden max-h-[400px] overflow-y-auto"
                      >
                    ...
                    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-3 sm:mb-4">
                          <span className="w-5 h-5 sm:w-6 sm:h-6 rounded-lg bg-[#f2e421] flex items-center justify-center text-[10px] sm:text-xs font-bold text-black">1</span>
                          <CalendarDays className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#f2e421]" />
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-3 sm:mb-4">
                          <span className="w-5 h-5 sm:w-6 sm:h-6 rounded-lg bg-[#f2e421] flex items-center justify-center text-[10px] sm:text-xs font-bold text-black">2</span>
                          <Users className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#f2e421]" />
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-3 sm:mb-4">
                          <span className="w-5 h-5 sm:w-6 sm:h-6 rounded-lg bg-[#f2e421] flex items-center justify-center text-[10px] sm:text-xs font-bold text-black">3</span>
                          <Car className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#f2e421]" />
                            ...
                            <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-3 sm:mb-4">
                              ...
                              >
                                <div className="flex items-center gap-1.5 sm:gap-2 mb-1">
                                  <Car className={`w-3.5 h-3.5 sm:w-4 sm:h-4 ${needPickup ? 'text-black' : 'text-slate-400'}`} />
                                  <span className={`text-xs sm:text-sm font-medium ${needPickup ? 'text-black' : 'text-slate-500'}`}>
                                    Hotel Pickup
                                  </span>
                                </div>
                                <p className={`text-[10px] sm:text-xs font-medium ${needPickup ? 'text-black/80' : 'text-green-600'}`}>FREE SHARED TRANSFER</p>
                              </button>
                              ...
                              >
                                <div className="flex items-center gap-1.5 sm:gap-2 mb-1">
                                  <Navigation className={`w-3.5 h-3.5 sm:w-4 sm:h-4 ${!needPickup ? 'text-black' : 'text-slate-400'}`} />
                                  <span className={`text-xs sm:text-sm font-medium ${!needPickup ? 'text-black' : 'text-slate-500'}`}>
                                    Come Direct
                                  </span>
                                </div>
                                <p className={`text-[10px] sm:text-xs ${!needPickup ? 'text-black/80' : 'text-slate-400'}`}>Self arrange</p>
                              </button>
                            </div>
                            ...
                            >
                              <div className="grid grid-cols-3 gap-3">
                                <div className="col-span-2">
                                  ...
                                  <div className="relative">
                                    <Hotel className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#f2e421]" />
                                    <input
                                      type="text"
                                      value={hotelName}
                                ...
                                <div className="flex items-center justify-between">
                                  <div className="flex items-center gap-3">
                                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                                      privateTransfer ? 'bg-[#f2e421]' : 'bg-slate-200'
                                    }`}>
                                      <Car className={`w-5 h-5 ${privateTransfer ? 'text-black' : 'text-slate-500'}`} />
                                    </div>
                                    <div>
                                  ...
                                  <div className={`w-11 h-6 rounded-full transition-colors ${privateTransfer ? 'bg-[#f2e421]' : 'bg-slate-300'}`}>
                                ...
                                <AnimatePresence>
                                  {privateTransfer && (
                                    ...
                                    >
                                      <div className="flex items-center justify-between">
                                      <div className="flex items-center gap-2">
                                        <div className="w-8 h-8 rounded-lg bg-[#f2e421]/10 flex items-center justify-center">
                                          <Users className="w-4 h-4 text-[#f2e421]" />
                                        </div>
                                          <div>
                        ...
                        {/* Meeting Point (when self-drive) */}
                            <AnimatePresence>
                              {!needPickup && (
                                <motion.div
                                  ...
                                  animate={{ opacity: 1, height: 'auto' }}
                                  exit={{ opacity: 0, height: 0 }}
                                  className="p-4 rounded-xl border-2 border-[#f2e421]/30 bg-[#f2e421]/5"
                                >
                                  <div className="flex items-start gap-3">
                                    <div className="w-10 h-10 rounded-lg bg-[#f2e421]/10 flex items-center justify-center flex-shrink-0">
                                      <MapPin className="w-5 h-5 text-[#f2e421]" />
                                    </div>
                                    <div>
                                      <p className="font-medium text-slate-800">Flying Hanuman</p>
                                      <p className="text-xs text-slate-500 mt-1">89/16 Moo 6, Soi Namtok Kathu, Kathu, Phuket 83120</p>
                                      <a 
                          ...
                          <div className="space-y-3 sm:space-y-4">
                            ...
                            <div className="p-3 sm:p-4 rounded-xl border-2 border-[#f2e421]/30 bg-[#f2e421]/5">
                              <div className="flex items-start gap-2 sm:gap-3">
                                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-[#f2e421]/10 flex items-center justify-center flex-shrink-0">
                                  <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-[#f2e421]" />
                                </div>
                                <div className="min-w-0">
                                  <p className="font-medium text-slate-800 text-sm sm:text-base">Flying Hanuman</p>
                                  <p className="text-[10px] sm:text-xs text-slate-500 mt-1">89/16 Moo 6, Soi Namtok Kathu, Kathu, Phuket 83120</p>
                                  <a 
                                    href="https://maps.app.goo.gl/hkNWgQQi1ksvYY37A" 
                                    target="_blank"
                      ...
                      <button
                        ...
                        className="w-full h-11 sm:h-13 rounded-xl font-bold text-black flex items-center justify-center gap-2 transition-all hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed group text-sm sm:text-base"
                        style={{
                          backgroundColor: '#f2e421',
                          boxShadow: isFormValid ? '0 10px 40px rgba(242, 228, 33, 0.3)' : 'none'
                        }}
                      >
        ...
        <Section className="relative overflow-hidden">
          <Container className="relative z-10">
            <div className="flex items-center justify-center py-20">
              <div className="w-8 h-8 border-2 border-white/30 border-t-[#f2e421] rounded-full animate-spin" />
            </div>
          </Container>
        </Section>
      </main>
