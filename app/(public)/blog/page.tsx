...
export const metadata: Metadata = generatePageMetadata(
  ...
  'Read the latest news, adventure tips, safety guides, and stories from Flying Hanuman Phuket. Discover zipline experiences, travel tips, and rainforest insights.',
  '/blog'
);
        ...
        <Container className="relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-[family-name:var(--font-trade-winds)] text-white mb-6">
              Adventure <span className="text-[#f2e421]">Stories</span>
            </h1>
            <p className="text-lg text-white/70">
              Tips, stories, and news from Phuket&apos;s premier zipline adventure
            </p>
          </div>
        </Container>
      </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {posts.map((post) => (
                <Link key={post.id} href={`/blog/${post.slug}`}>
                  <article className="group h-full bg-[#1a1a1a] rounded-2xl overflow-hidden border border-white/10 hover:border-[#f2e421]/30 transition-all duration-300">
                    {/* Image */}
                    ...
                    {/* Content */}
                    <div className="p-6">
                      <h2 className="text-xl font-[family-name:var(--font-trade-winds)] text-white mb-3 group-hover:text-[#f2e421] transition-colors line-clamp-2">
                        {post.title}
                      </h2>
                      ...
                      <div className="mt-4 pt-4 border-t border-white/10">
                        <span className="flex items-center gap-2 text-[#f2e421] text-sm font-medium group-hover:gap-3 transition-all">
                          Read More
