...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen">
        ...
        <Container className="relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-[family-name:var(--font-trade-winds)] text-white mb-6">
              Contact <span className="text-[#f2e421]">Us</span>
            </h1>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              >
                <h2 className="text-2xl font-[family-name:var(--font-trade-winds)] text-white mb-6">
                  Get in <span className="text-[#f2e421]">Touch</span>
                </h2>
                
                <div className="space-y-4">
                  <div className="flex items-start gap-4 p-4 bg-[#1a1a1a] rounded-xl border border-white/10">
                  ...
                  <div className="flex items-start gap-4 p-4 bg-[#1a1a1a] rounded-xl border border-white/10">
                    ...
                    <div>
                      ...
                      <a href="tel:+6676323264" className="text-[#f2e421] hover:underline">
                        +66 76 323 264
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-[#1a1a1a] rounded-xl border border-white/10">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@flyinghanuman.com" className="text-[#f2e421] hover:underline">
                ...
                <div className="pt-6 border-t border-white/10 mt-6">
                  ...
                  <div className="flex gap-3">
                    <a
                      href="https://facebook.com/flyinghanuman"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-10 h-10 bg-[#1a1a1a] border border-white/10 hover:bg-[#f2e421] hover:border-[#f2e421] rounded-lg flex items-center justify-center transition-all group"
                    >
                      <Facebook className="w-5 h-5 text-white group-hover:text-black" />
                    </a>
                    <a
                      href="https://instagram.com/flyinghanuman"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-10 h-10 bg-[#1a1a1a] border border-white/10 hover:bg-[#f2e421] hover:border-[#f2e421] rounded-lg flex items-center justify-center transition-all group"
                    >
            ...
            >
              <div className="bg-[#1a1a1a] rounded-2xl p-8 border border-white/10">
                <h2 className="text-2xl font-[family-name:var(--font-trade-winds)] text-white mb-6">
                  Send us a <span className="text-[#f2e421]">Message</span>
                </h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-3 bg-[#0f0f0f] border border-white/10 rounded-xl focus:outline-none focus:border-[#f2e421] transition-colors text-white placeholder:text-white/40"
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        required
                        className="w-full px-4 py-3 bg-[#0f0f0f] border border-white/10 rounded-xl focus:outline-none focus:border-[#f2e421] transition-colors text-white"
                      >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={5}
                      className="w-full px-4 py-3 bg-[#0f0f0f] border border-white/10 rounded-xl focus:outline-none focus:border-[#f2e421] transition-colors resize-none text-white placeholder:text-white/40"
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-[#f2e421] hover:bg-[#d4c91e] text-black font-medium rounded-xl transition-colors disabled:opacity-50"
                  >
                    {sending ? (
                      <>
      ...
      {/* Map Section */}
      <Section className="bg-[#1a1a1a] p-0 h-96">
        <iframe
