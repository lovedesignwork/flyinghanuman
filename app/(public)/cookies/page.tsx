    ...
    <main className="pt-20">
      <Section className="bg-gradient-to-b from-[#1a1a1a] to-[#2d2d2d] py-16">
        <Container>
          ...
          >
            <h1 className="text-4xl font-bold text-white mb-4 font-[family-name:var(--font-trade-winds)]">Cookie Policy</h1>
        ...
        <Container>
          ...
          >
            ...
            <div className="prose prose-slate max-w-none">
              ...
              <p>
                This Cookie Policy explains how <strong>SKY TREK ADVENTURES Co., Ltd.</strong> 
                (operating as "Flying Hanuman") uses cookies and similar technologies on our website.
              </p>
              ...
              <ul>
                <li><a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-[#f2e421] hover:underline">Google Privacy Policy</a></li>
                <li><a href="https://www.facebook.com/privacy/policy/" target="_blank" rel="noopener noreferrer" className="text-[#f2e421] hover:underline">Meta Privacy Policy</a></li>
                <li><a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="text-[#f2e421] hover:underline">Stripe Privacy Policy</a></li>
              </ul>
              ...
              <ul>
                <li><a href="https://support.google.com/chrome/answer/95647" target="_blank" rel="noopener noreferrer" className="text-[#f2e421] hover:underline">Google Chrome</a></li>
                <li><a href="https://support.mozilla.org/en-US/kb/cookies-information-websites-store-on-your-computer" target="_blank" rel="noopener noreferrer" className="text-[#f2e421] hover:underline">Mozilla Firefox</a></li>
                <li><a href="https://support.apple.com/guide/safari/manage-cookies-sfri11471/mac" target="_blank" rel="noopener noreferrer" className="text-[#f2e421] hover:underline">Safari</a></li>
                <li><a href="https://support.microsoft.com/en-us/microsoft-edge/delete-cookies-in-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09" target="_blank" rel="noopener noreferrer" className="text-[#f2e421] hover:underline">Microsoft Edge</a></li>
              </ul>
              ...
              <ul>
                <li>Email: privacy@flyinghanuman.com</li>
                <li>Phone: +66 76 323 264</li>
                <li>Address: 89/16 Moo 6, Soi Namtok Kathu, Kathu, Phuket 83120, Thailand</li>
              </ul>

              <p>
                For more information about how we handle your personal data, please see our{' '}
                <a href="/privacy" className="text-[#f2e421] hover:underline">Privacy Policy</a>.
              </p>
            </div>
          </motion.div>
        </Container>
