        ...
        <Section className="relative overflow-hidden min-h-[calc(100vh-80px)]">
          <Container className="relative z-10">
            <div className="max-w-lg mx-auto text-center py-20">
              <AlertCircle className="w-16 h-16 text-[#f2e421] mx-auto mb-4" />
              ...
              <Link href="/booking">
                <button className="px-8 py-3 bg-[#f2e421] hover:bg-[#d4c91e] text-black font-bold rounded-xl transition-colors">
                  Go to Booking
                </button>
              </Link>
            </div>
                      ...
                      <div className="flex-grow">
                        ...
                        <div className="flex flex-wrap gap-4 mt-3 text-sm">
                          <span className="flex items-center gap-1 text-slate-600">
                            <Calendar className="w-4 h-4 text-[#f2e421]" />
                    ...
                    {selectedPackage.includesTransfer && (
                      <div className="mt-4 pt-4 border-t border-slate-100">
                        <div className="flex items-start gap-3">
                          <Car className="w-5 h-5 text-[#f2e421] mt-0.5" />
                          <div>
                  ...
                  <div className="p-6 space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          placeholder="John"
                          className="w-full h-11 px-4 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 text-sm focus:outline-none focus:border-[#f2e421]"
                          required
                        />
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full h-11 pl-10 pr-4 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 text-sm focus:outline-none focus:border-[#f2e421]"
                          required
                        />
                      </div>
                    </div>
                      ...
                      <div className="flex gap-2">
                        <div className="relative w-24">
                          <select
                            ...
                            className="w-full h-11 px-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 text-sm focus:outline-none focus:border-[#f2e421] appearance-none"
                          >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 text-sm focus:outline-none focus:border-[#f2e421] resize-none"
                      />
                    </div>
                  </div>
                </motion.div>
                    ...
                    <div className="space-y-3 text-sm">
                          ...
                          <div>
                            <div className="flex gap-2">
                              <input
                                ...
                                className="flex-1 px-3 py-2 border border-slate-200 rounded-lg text-sm text-slate-800 uppercase placeholder:normal-case placeholder:text-slate-400 focus:outline-none focus:border-[#f2e421]"
                      ...
                      <div className="border-t border-slate-200 pt-3 mt-3">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-2xl font-bold text-[#1a1a1a] font-[family-name:var(--font-oswald)]">
