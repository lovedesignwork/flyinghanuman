          ...
          <div className="p-6 md:p-8">
            ...
            <div className="space-y-3 mb-8">
              ...
              <Link href="/booking" className="block">
                <div className="flex items-center gap-4 p-4 bg-[#f2e421]/10 hover:bg-[#f2e421]/20 rounded-xl transition-colors cursor-pointer">
                  <div className="w-12 h-12 bg-[#f2e421] rounded-lg flex items-center justify-center">
